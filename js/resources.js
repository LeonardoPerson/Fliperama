...
 * de arquivos de imagem para que possam ser usados ​​dentro do seu jogo. Inclui também
...
     * uma matriz de strings apontando para arquivos de imagem ou uma string para uma única
...
     * chamada pela função public loader de imagens.
     */
    function _load(url) {
...
     * foram previamente carregados. Se uma imagem é armazenada em cache, isso funciona
...
     * quando todas as imagens solicitadas estiverem carregadas corretamente.
     */
